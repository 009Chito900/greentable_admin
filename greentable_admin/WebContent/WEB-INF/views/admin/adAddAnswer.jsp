<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	info="관리자:문의글상세보기(답변예정)"
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>문의글상세보기(답변예정)</title>
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div class="table-responsive">
					<table class="myTable">
						...
						<tr class="header-sub">
							<td>답변</td>
							<td>
								<textarea id="askAnswer" rows="8">아직 답변없음</textarea>
							</td>
						</tr>
						</tbody>
					</table>
			...
			<div id="buttonDiv">
				<button type="button" id="askAddBtn" class="btn btn-success">답변 추가</button>
